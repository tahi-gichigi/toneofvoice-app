  ...
  return (
    <div className={cn("min-h-[60vh] flex flex-col justify-center px-12 md:px-20 py-16 bg-white relative overflow-hidden", className)}>
      ...
      <div className="relative z-10 space-y-8">
        <div className="max-w-3xl space-y-2 animate-in fade-in motion-safe:slide-in-from-bottom-4 duration-700 delay-100">
          {showPreviewBadge && (
            <Badge variant="secondary" className="bg-gray-100 text-gray-600 border-gray-200 mb-4 hover:bg-gray-100 transition-[background-color,box-shadow] duration-300 animate-in fade-in motion-safe:slide-in-from-left-4 duration-500">
              Preview Mode
            </Badge>
          )}
          <p className="text-sm font-medium text-gray-600 uppercase tracking-widest animate-in fade-in motion-safe:slide-in-from-bottom-2 duration-700 delay-200">
            {COVER_EYEBROW}
          </p>
        </div>

        <div className="space-y-6 animate-in fade-in motion-safe:slide-in-from-bottom-4 duration-700 delay-300">
          <h1
            className="text-7xl md:text-9xl font-bold tracking-tight text-gray-900 leading-[0.9] transition-[letter-spacing,transform] duration-500 hover:tracking-tighter hover:scale-[1.01] origin-left max-w-5xl text-balance"
            style={{ fontFamily: 'var(--font-display), serif' }}
          >
            {displayName}
          </h1>
          <div className="h-1 w-24 bg-gray-900 animate-in motion-safe:slide-in-from-left-4 duration-700 delay-500 rounded-full" />
        </div>

        <div className="pt-12 space-y-3 text-gray-600 animate-in fade-in motion-safe:slide-in-from-bottom-2 duration-700 delay-500 max-w-3xl">
          ...
          {subtitle && (
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-sm font-medium text-gray-900 transition-[color,transform] duration-300 hover:translate-x-1">
                {subtitle}
              </p>
            </div>
          )}
